...
<html lang="en">
    ...
    <body <?php if (isset($_SESSION["id"])) {echo "onload='directNavigationBar()'";} ?> >
        <div class="main-container">
            <h1 id="indexTitle">Best &amp; Certified</h1>
            
            <p id="indexSubtitle">Salon</p>
        ...
        <section>
            ...
            <div class="appointment-container">
                <div class="row">
                    ...
                    <br/>
                    <p><strong>Hair basic</strong> such as cuts, relaxers, perms, colors, shampoo, conditioning, curling, reconstructing, massage, Braids, weaving, waving. <strong>Hair treatment</strong> for different hair types such as Damaged, Normal / Dry, Very Dry &amp; Sensitized, Colour Treated,Curly / Rebellious, Thinning. <strong>Scalp treatment</strong> for different scalp problems such as Oily scalp, Sensitive scalp, Hair loss / thinning, Dandruff</p>
